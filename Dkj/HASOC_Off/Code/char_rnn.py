...
if __name__ == '__main__':
	...
	h5f = h5py.File('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task2/Xtest_new_experiment.h5', 'r')
	X_test = h5f['dataset'][:]
	h5f.close()
	print(X_test.shape)
	inp = open('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task2/Ytest_new_experiment.pkl', 'rb')
	...
	fp = open( 'E:/复现/BAKSA_IITK-master/HASOC_Off/' + 'pred.csv', 'w')
	fp.write(str(y_pred))