...
Modeldir = 'Models/'
Featuredir = 'Features/'
inputdatasetfilename = '翻译ml-Hasoc-offensive-train.txt'
inputdatasetfilename1 = '翻译dev201-400.txt'
...
def parse(Masterdir, filename, seperator, datacol, labelcol, labels):
    ...
    f = open('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task1/翻译ml-Hasoc-offensive-train.txt', 'r', encoding='utf-8')
    lines = f.read().lower()
    # print(lines)
...
DATA_COLUMN1 = 1
LABEL_COLUMN1 = 2
LABELS1 = ['0', '1', '2']  # 0 -> Negative, 1-> Neutral, 2-> Positive
mapping_char2num1 = {}
mapping_num2char1 = {}
MAXLEN1 = 200
...
def parse1(Masterdir1, filename1, seperator1, datacol1, labelcol1, labels1):
    ...
    f = open('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task1/翻译dev201-400.txt', 'r', encoding='utf-8')
    lines = f.read().lower()
    #print(lines)
...
def save_model(Masterdir, filename, model):
    ...
    f = open(Masterdir + 'Models/' + 'GRU_' + filename + '_architecture.h5', 'w')
    f.write(json_string)
    f.close()
...
#    out.write('Uid,Sentiment')
    for line in out:
        ...
        k+=1
        #print(str1)
        fd=open('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task1/pre/pred1.csv','a',encoding='utf-8')
        fd.write(str1)
...
# preds = pd.read_csv('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task1/pre/pred1.txt')#预测标签
