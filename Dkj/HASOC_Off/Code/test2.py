...
Modeldir = 'Models/'
Featuredir = 'Features/'
inputdatasetfilename = '翻译ml-Hasoc-offensive-train-dev.txt'
inputdatasetfilename1 = 'Tamil_test_lable.txt'
...
def parse(Masterdir, filename, seperator, datacol, labelcol, labels):
    ...
    f = open('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task1/翻译ml-Hasoc-offensive-train-dev.txt', 'r', encoding='utf-8')
    lines = f.read().lower()
    # print(lines)
...
inputdatasetfilename1 = '翻译test+lable.txt'
...
with open('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task1/pre/pred.csv', 'r') as out:
    ...
    for line in out:
        ...
        k += 1
        # print(str1)
        fd = open('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task1/pre/pred3.csv', 'a', encoding='utf-8')
        fd.write(str1)
