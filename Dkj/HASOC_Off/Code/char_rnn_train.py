...
#inputdatasetfilename = 'Malayalam_offensive_data_Training-YT.txt'
inputdatasetfilename = 'ml-Hasoc-offensive-train.txt'
...
DATA_COLUMN = 1
LABEL_COLUMN = 2
LABELS = ['0','1'] # 0 -> Offensive, 1-> Not-offensive
mapping_char2num = {}
mapping_num2char = {}
MAXLEN = 200
...
def parse(Masterdir,filename,seperator,datacol,labelcol,labels):
	...
	#f=open('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task2/Malayalam_offensive_data_Training-YT.txt','r',encoding='utf-8')
	f = open('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task1/ml-Hasoc-offensive-train.txt', 'r', encoding='utf-8')
	lines = f.read().lower()
...
if __name__ == '__main__':
	...
	h5f = h5py.File('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task1/Xtest_new_experiment.h5', 'r')
	X_test = h5f['dataset'][:]
	h5f.close()
	print(X_test.shape)
	inp = open('E:/复现/BAKSA_IITK-master/HASOC_Off/Data/task1/Ytest_new_experiment.pkl', 'rb')
	...
	evaluate_model(X_test, deepcopy(y_test), model, batch_size, 2)
	accuracy(y_test, y_pred)
	print('y_pred',y_pred)
	fp = open( 'E:/复现/BAKSA_IITK-master/HASOC_Off/pre/pred.csv', 'w')
	fp.write(str(y_pred))
